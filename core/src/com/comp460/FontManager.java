...
public class FontManager {
    public static final FreeTypeFontGenerator KEN_PIXEL = new FreeTypeFontGenerator(Gdx.files.local("common/fonts/kenpixel.ttf"));
    public static final FreeTypeFontGenerator KEN_PIXEL_BLOCKS = new FreeTypeFontGenerator(Gdx.files.local("common/fonts/kenpixel_blocks.ttf"));
